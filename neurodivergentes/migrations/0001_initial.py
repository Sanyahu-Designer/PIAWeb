    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tempo_prematuridade', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(20)], verbose_name='Tempo de Prematuridade (semanas)')),
                ...
                ('especialidade_medica', models.CharField(max_length=100, verbose_name='Especialidade Médica Avaliadora')),
                ...
                ('rel_mae', models.CharField(choices=[('otimo', 'Ótimo'), ('bom', 'Bom'), ('regular', 'Regular'), ('ruim', 'Ruim')], max_length=10, verbose_name='Relacionamento com a Mãe/Madrasta/Avó')),
                ('rel_pai', models.CharField(choices=[('otimo', 'Ótimo'), ('bom', 'Bom'), ('regular', 'Regular'), ('ruim', 'Ruim')], max_length=10, verbose_name='Relacionamento com o Pai/Padrasto/Avô')),
                ('rel_colegas', models.CharField(choices=[('otimo', 'Ótimo'), ('bom', 'Bom'), ('regular', 'Regular'), ('ruim', 'Ruim')], max_length=10, verbose_name='Relacionamento com Colegas')),
                ('rel_professores', models.CharField(choices=[('otimo', 'Ótimo'), ('bom', 'Bom'), ('regular', 'Regular'), ('ruim', 'Ruim')], max_length=10, verbose_name='Relacionamento com Professores')),
                ('rel_social', models.CharField(choices=[('otimo', 'Ótimo'), ('bom', 'Bom'), ('regular', 'Regular'), ('ruim', 'Ruim')], max_length=10, verbose_name='Relacionamento Social em Geral')),
                ('primeira_aprendizagem', models.TextField(verbose_name='Primeira Aprendizagem/Alimentação')),
                ('segunda_aprendizagem', models.TextField(verbose_name='Segunda Aprendizagem/Evolução Psicomotora')),
                ('terceira_aprendizagem', models.TextField(verbose_name='Terceira Aprendizagem/Fala')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta', models.CharField(max_length=200, verbose_name='Meta/Habilidade')),
                ('nivel', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Nível (%)')),
                ('observacoes', models.TextField(blank=True, verbose_name='Observações')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('neurodivergente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='monitoramentos', to='neurodivergentes.neurodivergente')),
            ],
            options={
                'verbose_name': 'PEI',
        ...
        migrations.AddField(
            model_name='anamnese',
            name='neurodivergente',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='anamnese', to='neurodivergentes.neurodivergente'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('neurodivergente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pdis', to='neurodivergentes.neurodivergente')),
                ('pedagogo_responsavel', models.ForeignKey(limit_choices_to={'profissao__startswith': 'pedagogo'}, on_delete=django.db.models.deletion.PROTECT, related_name='pdis_responsavel', to='profissionais_app.profissional', verbose_name='Pedagogo Responsável')),
            ],
            options={
                'verbose_name': 'PDI',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pedagogo_responsavel', models.ForeignKey(limit_choices_to={'profissao__startswith': 'educador'}, on_delete=django.db.models.deletion.PROTECT, related_name='planos_educacionais', to='profissionais_app.profissional')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('professor_responsavel', models.ForeignKey(limit_choices_to={'profissao__startswith': 'educador'}, on_delete=django.db.models.deletion.PROTECT, related_name='adaptacoes_curriculares', to='profissionais_app.profissional')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ano', models.IntegerField(validators=[django.core.validators.MinValueValidator(2000), django.core.validators.MaxValueValidator(2050)], verbose_name='Ano')),
                ...
                ('total_atendimentos', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)], verbose_name='Total de Atendimentos')),
                ('observacoes', models.TextField(blank=True, verbose_name='Observações')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('neurodivergente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='frequencias', to='neurodivergentes.neurodivergente')),
            ],
            options={
